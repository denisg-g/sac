class RegistersController < ApplicationController
  ...
  def register_params
    params.require(:register).permit(:student_id, :year, :colegio_precedencia, :pago, :repitente, :extracurricular, documents_attributes: %i[name description status register_id])
  end
end
