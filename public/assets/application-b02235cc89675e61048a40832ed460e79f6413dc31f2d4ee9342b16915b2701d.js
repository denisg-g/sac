...
function buscarPorTutor(){
   $("#boton_buscar").click(function(){
     var tutor = $("#tutor").val();
     $.ajax({
        url: "/tutor/buscar_por_tutor/" + tutor,
        dataType: "JSON",
        timeout: 10000,
        beforeSend: function(){
        ...
        error: function(){
           $("#respuesta").html("Error al intentar buscar el tutor. Por favor intente más tarde.");
        },
        success: function(res){
           if(res){
              $("#respuesta").html('<a href="/empleados/'+res.id+'"> '+res.nombre+' ' + res.apellido + ' </a>');
           }else{
              $("#respuesta").html("El legajo no le pertenece a ningún tutor.");
           }
        }
     })
  });
